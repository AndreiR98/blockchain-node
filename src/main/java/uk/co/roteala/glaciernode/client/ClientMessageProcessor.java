...
/**
 * Process messages coming from other server, in this case the node acts as a client
 * */
@Slf4j
@RequiredArgsConstructor
public class ClientMessageProcessor implements Consumer<Mono<MessageTemplate>> {
    ...
    private void internalMessageTemplateProcessor(MessageTemplate messageTemplate) {
        if(messageTemplate.getHandler() == HandlerType.CLIENT) {
